...
function ValidationTestOneEmail (StaffName,FormName, msg){
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission. The passcode entered does not match your passcode. Please double check your entry and try again. If this error persists please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=passcode%20not%20working" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
...
function ValidationTestTwoEmail(StaffName, PriNo, FormName, to, subject, msg){
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission. The Database record of Member Id ' + PriNo + ' does not exist. Please double check your entry and try again. If the entered member id is correct, please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=Member%20exists%20'+PriNo+'" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
}   
...
function ValidationTestTwoEmail_B(StaffName, UserID, FormName, to, subject, msg){
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission. The Database record of Member Id ' + UserID + ' does not exist. Please double check your entry and try again. If the entered member id is correct, please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=Member%20exists%20'+UserID+'" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
}   
...
function ValidationTestSixEmail(StaffName, memberNo, FormName, LockerNo, to, subject, msg) {
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission on form ' + FormName + '. The database record of member Id ' + memberNo + ' does not have the locker '  +  LockerNo + '. Please double check your entry and try again. If both the entered locker number and id are correct, please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=Wrong%20Locker%20'+memberNo+'" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission on form ' + FormName + '. There appears to be no lockers availble for rental. Please double check the database to ensure this is accurate. If this is an error please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=lockers%20not%20working" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission on form ' + FormName + '. The entered PAL date is expired ' + PAL + '. Please double check your entry and try again. If this is an error please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=PAL%20Expiry%20not%20working" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission on form ' + FormName + '. Member is below the age of majority ' + majority + '. Please double check your entry and try again. If this is an error please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=majority%20form%20not%20working" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission on form ' + FormName + '. Primary member  ' + primaryMember + ' has an expired Range membership. Please double check your entry and try again. If this is an error please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=primary%20member%20not%20expired" target="_top"> EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission on form ' + FormName + '. Member  ' + memberNo + ' already has a tactical certification. Please double check your entry and try again. If this is an error, please use the <a href="https://docs.google.com/forms/d/e/FORM_ID/viewform"> member edit form </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
  ...
  var payload = '<html>\r\n<body>\r\n\r\n<h2>Hey '+ StaffName + ',<\/h2>\r\n<br>\r\n\r\n<p> There was an error with your submission. This account is an addon account of member ' + PriAccount + '. Please double check your entry and try again. If the entered member id is correct, please send this email to <a href="mailto:EMAIL_ADDRESS?Subject=Not%20a%20addon%20account%20of%20'+PriNo+'" target="_top">EMAIL_ADDRESS </a> to correct the probLEO.   <\/p>'
  GmailApp.sendEmail(email, subj, msg,{
    htmlBody: payload
  })
